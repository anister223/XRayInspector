...
/*
    private static final String KERNEL_CU =
        ...
        "}\n";
*/
    private static final String KERNEL_CU = FileUtils.loadAsString("/shaders/rayCastTest.cu");
    
    private static final String KERNEL_NAME = "render";

    private static long ctx;

    public static FloatBuffer temp() {
        ByteBuffer PTX;
        try (MemoryStack stack = stackPush()) {
            ...
            System.out.println("Compiling kernel with NVRTC v");

            PointerBuffer pp = stack.mallocPointer(1);

            checkNVRTC(nvrtcCreateProgram(pp, KERNEL_CU, "rayCastTest.cu", null, null));
...
*/
        FloatBuffer hostFb = memAllocFloat(WIDTH * HEIGHT);
...
*/
        ...
        try (MemoryStack stack = stackPush()) {
            ...
            // allocate memory
            check(cuMemAlloc(pp, Float.BYTES * WIDTH * HEIGHT));
            deviceFb = pp.get(0);
/*
...
*/
            ...
            check(cuMemcpyHtoD(deviceFb, hostFb));
            ...
            check(cuLaunchKernel(
                function, WIDTH * HEIGHT, 1, 1,  // Nx1x1 blocks
                1, 1, 1,            // 1x1x1 threads
                0, 0,
                // method 1: unpacked (simple, no alignment requirements)
                stack.pointers(
                    memAddress(stack.longs(deviceFb))
        ...
        check(cuMemcpyDtoH(hostFb, deviceFb));
        /*
